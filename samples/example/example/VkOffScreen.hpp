...
#undef QUAD_COLOR_NORMAL
	...
	void setupDescriptorPool()
	{
		std::vector<VkDescriptorPoolSize> poolSizes =
		{
			...
			vkTools::descriptorPoolSize(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 8)
		};
	...
	void setupDescriptorSetLayout()
	{
		...
		descriptorLayoutInfo = vkTools::descriptorSetLayoutCreateInfo(setLayoutBindings.data(), 1);
		...
		pipelineLayoutInfo = vkTools::pipelineLayoutCreateInfo(&descriptorSetLayouts.shaded, 1);
		...
		descriptorLayoutInfo = vkTools::descriptorSetLayoutCreateInfo(setLayoutBindings.data(), static_cast<uint32_t>(setLayoutBindings.size()));
		...
		pipelineLayoutInfo = vkTools::pipelineLayoutCreateInfo(&descriptorSetLayouts.textured, 1);
