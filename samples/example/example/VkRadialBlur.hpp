...
public:
	...
	void setupDescriptorSetLayout()
	{
		...
		pPipelineLayoutCreateInfo = vkTools::pipelineLayoutCreateInfo(&descriptorSetLayouts.scene, 1);
		...
		pPipelineLayoutCreateInfo = vkTools::pipelineLayoutCreateInfo(&descriptorSetLayouts.radialBlur, 1);
	...
	void setupDescriptorSet()
	{
		...
		// Scene rendering
		descriptorSetAllocInfo = vkTools::descriptorSetAllocateInfo(descriptorPool, &descriptorSetLayouts.scene, 1);
		...
		// Fullscreen radial blur
		descriptorSetAllocInfo = vkTools::descriptorSetAllocateInfo(descriptorPool, &descriptorSetLayouts.radialBlur, 1);
